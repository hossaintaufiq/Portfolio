...
const ProjectItems = ({img, title}) => {
    return (
        <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]">
            <img src={img} alt="/" className="rounded-l group-hover:opacity-10 h-[300px]" />
            <div className="hidden group-hover:block absolute top-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <a href="/">
                    <p className="text-center p-3 bg-white rounded-lg text-gray-700 font-bold cursor-pointer text-lg ">..More Info</p>
                </a>
            </div>
        </div>
    );
